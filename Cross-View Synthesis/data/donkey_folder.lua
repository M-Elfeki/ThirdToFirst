...
-- opt.data = paths.concat('/home/user/Documents/Elfeki/ReConstruction/', opt.phase)
...
-- load mat files instead of images
...
local function loadImage(path)
   ...
   local imA = tensors.opt_flow.side_flow
   local imB = tensors.opt_flow.ego_flow
...
trainLoader = dataLoader{
    paths = {opt.data},
    loadSize = {loadSize[2], loadSize[2], input_nc},
    sampleSize = {sampleSize[2], sampleSize[2], input_nc+output_nc},
    split = 100,
